...
working_dir = osp.abspath(osp.join(osp.dirname("__file__")))
...
# Name of backbone
# _C.MODEL.NAME = 'resnet50'   # # resnet50_ibn_a, resnet50
_C.MODEL.NAME = 'resnet50_ibn_a'
# Last stride of backbone
_C.MODEL.LAST_STRIDE = 1
# Path to pretrained model of backbone
_C.MODEL.PRETRAIN_PATH = (osp.join(working_dir, 'r50_ibn_a.pth'))   # resnet_ibn
...
# -----add new params----------
_C.MODEL.INPUT_CAM_DIM = int(2048)
_C.MODEL.CAM_FIRST_FILTER_DIM = int(1024)
_C.MODEL.ACTIVE = 'relu'
_C.MODEL.PAD_TYPE = 'reflect'
_C.MODEL.DIS_INPUT_TYPE = 'reduce'
_C.MODEL.CAM_ENCODER_LR = 0.01
_C.MODEL.DIS_LR = 0.01
_C.MODEL.TRAIN_EPOCH = 150
...
# market_cam:6, duke_cam:8, msmt17_cam:15  (('market1501') int(6))  (('dukemtmc') int(8)) (('msmt17') int(15)) (('cuhk03') int(6))
# prid,grid,viper,VeRi
_C.DATASETS.NAMES = ('market1501')
_C.DATASETS.NUM_CLASSES_S = int(0)
# List of target datasets
_C.DATASETS.TNAMES = ('dukemtmc')
# _C.DATASETS.MSMT17 = ('msmt17')

_C.DATASETS.ROOT_DIR = (osp.join(working_dir, 'datasets'))
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
_C.OUTPUT_DIR = osp.join(working_dir, "logs/market_duke/")
# _C.OUTPUT_DIR = './logs'
